...
import { Music, Play, Star, MoreHorizontal, ListPlus, Info } from "lucide-react";
...
const PopularSongsSection = () => {
  ...
  useEffect(() => {
    const fetchPopular = async () => {
      try {
        // Lấy top 10 popular songs (sort theo playCount)
        const popularSongs = await songsApi.getTop10();
    ...
    <section className="mb-12">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Popular Songs</h2>
