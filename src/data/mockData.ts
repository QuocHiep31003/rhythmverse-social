...
export const getTrendingSongs = () => mockSongs.slice(0, 10);
export const getNewReleases = () => mockSongs.slice(10, 20);
export const getAIRecommended = () => [mockSongs[1], mockSongs[4], mockSongs[7], mockSongs[11], mockSongs[15]];
